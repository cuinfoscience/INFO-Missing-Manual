...
| [`aar/2026-09-25-peer-review.md`](aar/2026-09-25-peer-review.md) | Ten simulated peer reviews of the whole book, written by AI agents in fictional personas from computer science education, library and information science, the quantitative social sciences, and project management, right after the voice rewrite. |
...
| [`plans/2026-09-24-screenshots.md`](plans/2026-09-24-screenshots.md) | Real screenshots for the twelve placeholders and beyond, with `tools/shots`: routes, milestones, the pilot, and the decisions it needs. The pilot (M1) is done; the rest is proposed. |
...
| [`plans/2026-09-25-voice-rollout.md`](plans/2026-09-25-voice-rollout.md) | The book's new voice, one part per pull request: how each chapter is rewritten and reviewed, what Part I taught, and the brief each chapter's agent receives. Done (#61–#68). |
