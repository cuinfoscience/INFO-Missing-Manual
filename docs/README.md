...
| [`plans/2026-09-24-cloud-storage-sections.md`](plans/2026-09-24-cloud-storage-sections.md) | Issue #34: new sections on how much space tools take (chapter 9) and on cloud sync, access, and sharing (chapter 10). Proposed. |
