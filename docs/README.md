...
| [`plans/2026-09-25-peer-review-revisions.md`](plans/2026-09-25-peer-review-revisions.md) | The revision plan built from those reviews: eight decisions for the maintainer, then six phases from quick corrections to new chapters and checkable exercises. Phase 1 done (#70); the rest proposed. |
