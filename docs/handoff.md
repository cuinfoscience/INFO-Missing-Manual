...
- **Open pull request from `claude/markdown-chapter-expansion-difpcc`:** the peer-review file made anonymous (reviewers identified by role only), and this note brought up to date.
