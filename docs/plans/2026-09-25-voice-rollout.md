...
**Status:** in progress. The pilot (`tabular-data`, #61) and Parts I–V (#62–#66) are done; Parts VI and VII, the appendices, the introduction, and the conclusion remain. Progress goes in [`handoff.md`](../handoff.md) and the checklist in [`roadmap.md`](../roadmap.md).
