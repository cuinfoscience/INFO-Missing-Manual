...
**Status:** in progress. The pilot (`tabular-data`, #61) and Parts I–VI (#62–#67) are done; Part VII, the appendices, the introduction, and the conclusion remain. Progress goes in [`handoff.md`](../handoff.md) and the checklist in [`roadmap.md`](../roadmap.md).
