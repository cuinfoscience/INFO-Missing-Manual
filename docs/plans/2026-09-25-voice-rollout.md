...
**Status:** in progress. The pilot (`tabular-data`, #61) and Parts I (#62), II (#63), III (#64), and IV (#65) are done; Parts V–VII, the appendices, the introduction, and the conclusion remain. Progress goes in [`handoff.md`](../handoff.md) and the checklist in [`roadmap.md`](../roadmap.md).
