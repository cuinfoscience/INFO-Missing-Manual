...
- **M3, review thread:** `collaboration` (1), once its source is chosen. *Done 2026-09-25,* with `version-control`'s diff: one thread on #47, written by Claude Code and blurred, captured before and after it was resolved ([`decisions.md`](../decisions.md)).
