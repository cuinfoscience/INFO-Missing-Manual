...
margin-header: |
  ![](/graphics/memes/sql-basics.png){.chapter-meme fig-alt="Boat cate Meme: I should build a database."}
---
...
Use `*` to return every column (fine in the REPL, discouraged in scripts because it couples your code to the current [schema](appendix-glossary.qmd#term-schema)):
