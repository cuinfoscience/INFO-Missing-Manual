...
3.  Ask an assistant for three published papers, with [DOIs](appendix-glossary.qmd#term-doi), on a topic from one of your courses. Look each up on [Google Scholar](https://scholar.google.com/) or at `https://doi.org/<the DOI>`. How many exist, and do they say what the assistant claimed?
