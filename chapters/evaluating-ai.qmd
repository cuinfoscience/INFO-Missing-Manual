...
See @sec-artifacts-politics for the broader framework, @sec-llm-internals for the model-level biases your audit will be measuring, and @sec-ai-agents for what changes when the system is taking autonomous actions instead of returning text. The concrete prompt to carry forward: when you design or read an audit, ask whose definition of fairness it operationalizes, whose data it measures, and who could have run it differently.
