...
**Add every failure you find,** so the same mistake can't come back unnoticed. **And keep the set like raw data** (see @sec-tabular-data): save it as a CSV, commit it, note where each example came from, and never quietly edit an answer to make a new prompt look better.
