...
## What if I leaked personal data?
...
**Remove it, and assume it's been copied.** Delete the file, make the repository private if you can, and stop sharing whatever you shared. But a public repository can be cloned or forked within minutes, and you can't recall text you pasted into an online service (see @sec-ai-llm), so act as though a copy exists somewhere.
