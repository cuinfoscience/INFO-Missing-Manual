...
::: {.column-margin}
![ALT: GitHub pull request page showing the diff view with red removed lines and green added lines side by side, plus a reviewer comment thread anchored to a specific line.](graphics/PLACEHOLDER-github-pr-diff.png){#fig-github-pr-diff}
:::
