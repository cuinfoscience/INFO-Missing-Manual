...
::: {.column-margin}
![ALT: GitHub repository page showing the Code tab, the list of top-level files, and the README rendered underneath. The navigation tabs (Code, Issues, Pull requests, Actions) are visible along the top of the page.](graphics/PLACEHOLDER-github-repo.png){#fig-github-repo}
:::
