# Images for text-editors

Figures in `chapters/text-editors.qmd`. `tools/shots` writes the table below from `provenance.json`
...
|---|---|---|---|---|
| `vscode-overview.png` | capture | 2026-09-24 | http://localhost:8898/ | tools/shots: Google Chrome for Testing 154.0.8037.57, 1024×768 at 2× |
<!-- shots:end -->
