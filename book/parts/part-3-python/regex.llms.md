...
## 18.1 1. The seven metacharacters you actually need
...
## 18.2 2. Character classes: the shortcut for “one of these”
...
## 18.3 3. Anchors: where in the string
...
## 18.5 5. Capture groups: extracting parts of a match
...
## 18.8 8. Worked examples

### Example 1: extract order IDs from free-text notes
...
### Example 4: grep from the terminal
