...
## 20.1 1. CSV: the workhorse, and its quirks
...
## 20.2 2. TSV and other delimited formats
...
## 20.3 3. JSON: when the structure is nested
...
## 20.4 4. Excel: the format you cannot escape
...
## 20.5 5. Parquet: the format for real data work
...
## 20.6 6. Text encoding in general
...
## 20.7 7. Worked examples

### Example 1: a “normal” CSV that is not normal
...
### Example 2: silent missing-value corruption
...
### Example 3: nested JSON from a web API
...
### Example 4: Excel with a four-row banner
