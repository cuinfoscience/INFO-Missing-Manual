...
A plain-text file format for structured data that supports nested objects and arrays. It is the dominant format for data returned from web APIs. See [sec-data-file-formats](#sec-data-file-formats).
