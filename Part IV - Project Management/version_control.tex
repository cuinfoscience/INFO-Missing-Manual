...
\begin{itemize}
\item Code view, issues, pull requests, actions, releases (Chapter~\ref{ch:automation} covers GitHub Actions and CI in depth).
...
\end{itemize}
\marginnote{Chapter~\ref{ch:collaboration} covers the full mechanics of authoring, reviewing, and responding to PRs.}
...
\item Ignore caches and generated outputs (\texttt{\_\_pycache\_\_}, \texttt{.ipynb_checkpoints/}).
