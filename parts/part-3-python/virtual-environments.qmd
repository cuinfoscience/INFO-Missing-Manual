...
meme:
  ...
  lines:
    ...
    - "USE A `VENV`"
    - "USE `CONDA`"
    - "DELETE PYTHON, INSTALL FRESH"
  alt: "You installed a package globally with sudo. Then you broke a system tool. Then you tried venv. Then conda. Now you're considering reinstalling Python entirely. It's 2 a.m."
  rationale: "humor -- escalating 'wisdom' that is actually escalating despair"
---
