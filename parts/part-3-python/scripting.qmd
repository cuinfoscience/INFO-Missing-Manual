...
meme:
  ...
  lines:
    ...
    - "A 47-CELL NOTEBOOK"
    - "IS THIS A SCRIPT?"
  alt: "Your notebook has 47 cells, four of them broken, and your advisor wants you to 'just run it from the command line.' `argparse` looks like a foreign language."
  rationale: "humor -- the existential question of whether a giant notebook even is a script"
---
