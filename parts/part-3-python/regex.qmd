...
meme:
  template: "cmm"
  lines:
    - "MY REGEX WORKS AND I HAVE NO IDEA WHY"
  alt: "You wrote a regex. It worked. You can no longer read it. Two weeks from now you will have to modify it and you will lose an afternoon."
  rationale: "irony -- the working regex that even its author cannot decipher"
---
...
## The seven metacharacters you actually need
...
## Character classes: the shortcut for "one of these"
...
-   **Parsing JSON.** Use the `json` module. See @sec-data-file-formats.
...
The `grep` command uses regex too. From @sec-terminal:
