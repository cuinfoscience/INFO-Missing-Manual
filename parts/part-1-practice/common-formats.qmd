...
meme:
  template: "db"
  lines:
    - "ANOTHER FILE EXTENSION I'VE NEVER HEARD OF"
    - "ME"
    - "THE PLAIN .CSV I WAS PROMISED"
  alt: "The instructor said \"open the CSV\" but the file is semicolon-separated, the encoding is mystery-meat, and there's a byte-order mark you've never heard of."
  rationale: "humor -- pining for the simple .csv we were promised"
---
