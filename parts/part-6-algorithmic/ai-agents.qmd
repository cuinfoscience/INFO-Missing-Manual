...
meme:
  template: "cb"
  lines:
    - "I LET MY AGENT RUN UNSUPERVISED OVERNIGHT"
    - "IT DELETED A DIRECTORY I ACTUALLY NEEDED"
  alt: "You set the agent loose on a small task. Eight hours later, it has spent $200, made fourteen unrelated edits, and confidently deleted a file you wanted to keep."
  rationale: "humor -- the confession-bear sheepishness of admitting you let it run unsupervised"
---
