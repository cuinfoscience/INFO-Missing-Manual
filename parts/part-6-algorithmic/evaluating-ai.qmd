...
meme:
  template: "dwight"
  lines:
    - "FACT: A BENCHMARK SCORE"
    - "TELLS YOU NOTHING ABOUT YOUR ACTUAL USE CASE"
  alt: "Every model claims state-of-the-art. The benchmark numbers are rising. Your actual application is silently getting worse and you have no way to prove it."
  rationale: "irony -- Schrute Facts as the most credible delivery mechanism for 'benchmarks are not your use case'"
---
