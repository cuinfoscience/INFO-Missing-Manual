...
meme:
  ...
  lines:
    - ""
    - "GIT PUSH --FORCE"
  alt: "You ran `git push --force` to fix a small thing. You have just overwritten three days of your collaborator's work. They have no backups. You have no time machine."
  rationale: "anxiety -- the irreversible-action regret reaction, distilled"
---
