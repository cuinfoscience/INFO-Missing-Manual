...
meme:
  ...
  alt: "Your collaborator's variable names are single letters. Their indentation is mixed tabs and spaces. They keep using `pickle` for things that aren't pickleable. They are also your friend."
  rationale: "humor -- Inigo's polite confrontation, repurposed for the reproducibility wars"
---
