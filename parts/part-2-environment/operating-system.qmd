...
meme:
  template: "ds"
  lines:
    - "FOLLOW THE LINUX TUTORIAL VERBATIM"
    - "USE THE OS YOU ALREADY HAVE"
  alt: "Every tutorial assumes macOS. You have a Windows laptop. The instructions don't say which OS they're for, and the fixes for yours are buried four Stack Overflow answers deep."
  rationale: "frustration -- a quiet OS-tax on the wrong half of the class"
---
