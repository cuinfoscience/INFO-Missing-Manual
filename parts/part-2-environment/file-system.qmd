...
meme:
  ...
  lines:
    ...
    - "NO IDEA"
  alt: "You saved a file and now you can't find it. macOS hid the Library folder, Windows hid the file extension, and `~` is either your home directory or a typo."
  rationale: "humor -- the cheerful shrug of total spatial confusion"
---
