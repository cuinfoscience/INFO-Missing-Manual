...
meme:
  ...
  lines:
    - "WHAT IF I TOLD YOU"
    - "DECLARATIVE IS JUST IMPERATIVE WITH EXTRA STEPS"
  alt: "SQL was designed in 1974. It still runs the world. The syntax feels like time travel and a JOIN takes three tries even when you know what you're doing."
  rationale: "humor -- Morpheus revealing the open secret that 'declarative' is a polite fiction"
---
