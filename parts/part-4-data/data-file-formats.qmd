...
## 1. CSV: the workhorse, and its quirks
...
## 2. TSV and other delimited formats
...
## 3. JSON: when the structure is nested
...
## 4. Excel: the format you cannot escape
...
## 5. Parquet: the format for real data work
