...
meme:
  template: "rollsafe"
  lines:
    - "CAN'T HIT THE RATE LIMIT"
    - "IF YOU NEVER MAKE THE REQUEST"
  alt: "You finally got the auth working. Three calls in, you hit the rate limit. The error response is in JSON, deeply nested, and the documentation page 404s."
  rationale: "irony -- Roll Safe captures the smug self-defeating cope of 'I'll just cache everything'"
---
