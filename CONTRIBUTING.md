...
- **Voice.** Talk to the reader as "you", like a friendly, experienced colleague, not like technical documentation. Say out loud what usually confuses people, explain *why* as well as *how*, and let each paragraph lead to the next rather than listing facts. Link tools to their official tutorials and concepts to Wikipedia. Be direct about steps ("Run this command") and never make the reader feel slow. `chapters/tabular-data.qmd` shows the voice.
